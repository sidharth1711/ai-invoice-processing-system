...
10. Extract the invoice-level discount into the discount field.
11. If no invoice-level discount is shown, return null.
12. Do not include invoice-level discount in individual line items.
"""
